/* Todos os trabalhos devem ter menu de opera��es
Fun��es (poe, pega, lista, conta o numero de elementos, busca um elemento(booleano) e permanencia)
...
void permanencia(celula *_i){ //D�VIDA: TEMPO MEDIO S� DOS ELEMENTOS QUE SAIRAM, DE TODOS OU S� OS QUE EST�O NA FILA?
...
int main()
{
    ...
    do{
        ...
        case 6:
            //printf("Qual elemento deseja saber sua perman�ncia? \n");
            //scanf("%d", &elem);
            permanencia(lista);
            break;
        }
